...
contract MuseumVIPTicket is ERC721URIStorage, Ownable {
    ...
    constructor () ERC721 ("MuseumVIPTicket", "Cr3w") Ownable(){
        tokenId = 1;
    ...
    function createNFT(string memory tokenURI) public payable hasMintFee() returns (uint256) {
        require(tokenId <= 223, 'All 223 tokens have been minted!');
        if(msg.sender != owner()){
